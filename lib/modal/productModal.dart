...
//
//     final productDataModal = productDataModalFromJson(jsonString);

import 'dart:convert';

ProductDataModal productDataModalFromJson(String str) =>
    ProductDataModal.fromJson(json.decode(str));

String productDataModalToJson(ProductDataModal data) =>
...
class ProductDataModal {
  ...
  factory ProductDataModal.fromJson(Map<String, dynamic> json) =>
      ProductDataModal(
        status: json["status"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        typicalPriceRange: json["typical_price_range"] == null
            ? []
  ...
  Map<String, dynamic> toJson() => {
        ...
        "typical_price_range": typicalPriceRange == null
            ? []
...
enum Department { KIDS_GIRLS, MEN_S, KIDS_BOYS, KIDS, WOMEN_S }
